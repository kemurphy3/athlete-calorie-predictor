"""
Sweet Spot Calorie Prediction Model - Clean Version
Balanced approach for TrainingPeaks take-home project
"""
...
class SweetSpotCaloriePredictor:
    ...
    def clean_data(self):
        ...
        # missing_calories = self.df['CALORIES'].isnull().sum()
        # self.df = self.df.dropna(subset=['CALORIES'])
        # print(f"Removed {missing_calories:,} rows with missing calories")
    ...
    def run_analysis(self):
        ...
        print("=== SWEET SPOT CALORIE PREDICTION ANALYSIS ===")
        print("=" * 50)
        ...
        self.analyze_athlete_distribution()
        
        # Clean data
        self.clean_data()
        self.visualize_cleaned_data()
        
        # Create features and train model
        self.create_features()
        mae, r2, cv_mae = self.train_model()
...
def main():
    ...
    # Run analysis
    predictor = SweetSpotCaloriePredictor('workout_data.csv', sample_size=50000)
